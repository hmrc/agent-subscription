...
trait DesStubs {
  ...
  private val invalidUtrResponse =
    errorResponse("INVALID_UTR", "Submission has not passed validation. Invalid parameter UTR.")

  private val ctUtrNotFoundResponse =
    errorResponse("NOT_FOUND", "The back end has indicated that CT UTR cannot be returned.")

  private val invalidCrnResponse =
    errorResponse("INVALID_CRN", "Submission has not passed validation. Invalid idType/idValue.")

  private val vatRecordNotFoundResponse =
    errorResponse("NOT_FOUND", "The back end has indicated that vat known facts cannot be returned")

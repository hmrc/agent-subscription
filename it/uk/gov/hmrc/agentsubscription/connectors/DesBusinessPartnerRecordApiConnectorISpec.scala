...
class DesBusinessPartnerRecordApiConnectorISpec extends UnitSpec with OneAppPerSuite with WireMockSupport with DesStubs {
  ...
  "DES Subscription Connector" should {
      "return subscription details for an agent matching UTR" in {
        ...
        result shouldBe BusinessPartnerRecordFound("BN12 4SE", isSubscribedToAgentServices = true)
      }

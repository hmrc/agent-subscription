...
import uk.gov.hmrc.agentsubscription.model.{AuthProviderId, Crn}
...
object UrlBinders {
  ...
  implicit val authProviderIdBinder: SimpleObjectBinder[AuthProviderId] =
    new SimpleObjectBinder[AuthProviderId](AuthProviderId.apply, _.id)

...
object CtUtrMatchResponse {
  case object Match extends CtUtrMatchResponse
  case object NoMatch extends CtUtrMatchResponse
  case object UtrNotFound extends CtUtrMatchResponse
  case object InvalidCrn extends CtUtrMatchResponse
  case object UnknownError extends CtUtrMatchResponse
}

@Singleton
class CTReferenceService @Inject() (desConnector: DesConnector) {

  def matchCorporationTaxUtrWithCrn(utr: Utr, crn: Crn)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[CtUtrMatchResponse] = {
